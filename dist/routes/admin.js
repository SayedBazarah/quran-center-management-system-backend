...
AdminRouter.post("/", middlewares_1.isAuthenticated, (0, middlewares_1.requirePermissions)(permissionSeeds_1.GlobalPermissionCode.CreateAdmin), validators.createAdmin, controllers.createAdmin);
...
AdminRouter.patch("/:id", middlewares_1.isAuthenticated, (0, middlewares_1.requirePermissions)(permissionSeeds_1.GlobalPermissionCode.UpdateAdmin), validators.updateAdmin, controllers.updateAdminById);
