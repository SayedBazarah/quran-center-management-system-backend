...
export const env = {
  ...
  frontend: {
    ...
    setupWizard:
      process.env.FRONT_SETUP_WIZARD || "http://localhost:8083/setup-wizard",
  },
  ...
  admin: {
    ...
    phone: process.env.ADMIN_PHONE || "201019910600",
    nationalId: process.env.ADMIN_NATIONAL_ID || "10001000100010",
